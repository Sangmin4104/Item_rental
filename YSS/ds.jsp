...
.buttonl{
        ...
        display: inline-block;
        font-size: 18px;
        position: relative; top:260px; left:600px;
    }
    .buttonl:hover{
        background-color: black;
        border-radius:5px;
...
<body>
    ...
    %> 
        ...
        <form method="post" action="ds2.jsp">
        <div>
            <span class="title"><strong>물 품 대 여 신 청</strong></span>
        </div>
...
<tr >
    <td align="center"><input type="text" id="pp_pname" name="p_pname" style="text-align:center; border: none;" value=<%=p_pname%>  class="boxP" readonly></td>
    <td align="center"><input type="text" id="ddname" name="dname"style="text-align:center; border: none;" value=<%=dname%> class="boxP" readonly></td>
    <td align="center"><input type="text" id="ssname" name="sname" style="text-align:center; border: none;" value=<%=sname%> class="boxP" readonly></td>
    <input type="text" id="p_pnum" name="p_pnum" style="text-align:center; border: none;" value=<%=p_pnum%> class="boxP" hidden>
    <td align="center"> <input type="number" id="aamount" name="amount" style="text-align:center; border: none;" value=<%=p_amount%> min='1' max=<%=p_amount%> id="inptext"  onfocusout="onlyNumber();"/> </td>
    <td align="center"> <p><input type="text" id="datetimes" name="datetimes" style="text-align:center; border: none;" style="width:300px" /></p></td>

     
<input type="submit" class="buttonl" style="position: relative; top:260px; left:615px;" value="입력완료"><br>
</tr>
</form>
