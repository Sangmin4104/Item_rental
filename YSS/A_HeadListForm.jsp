...
<body>
    <div class="container">
        <div class="squ">
            ...
            <button class="button3" onclick="location='A_NHeadListForm.jsp'">과대추가</button>
        </div>
        <div class="squ2">
        ...
        <div>
            <span class="title"><strong>과 대 해 제</strong></span>
        </div>
            <tbody>
...
String sql = "";
 try{
  ...
  conn=DriverManager.getConnection(jdbcUrl, dbId, dbPass );
      ...
      sql = "SELECT * from id where SHEAD = 1";
...
<tr align="center">
    ...
    <td><%=SNAME%></td>
    <td>O</td>
    <td onclick="location='A_HeadListPro.jsp?SNUM=<%=SNUM%>&DNAME=<%=DNAME%>&SNAME=<%=SNAME%>&SHEAD=<%=SHEAD%>'"><i style="cursor:pointer;" class="fa-solid fa-user-minus"></i></td>
</tr>
