...
<style>
  .buttonl{
        ...
        font-size: 18px;
        position: relative; top:477px; left:560px;
    }
    .buttonl:hover{
    ...
    .buttonl2{
        ...
        display: inline-block;
        font-size: 18px;
        position: relative; top:-180px; left:660px; 
    }
    .buttonl2:hover{
        background-color: black;
        border-radius:5px;
...
<body>
    ...
    %> 
        ...
        <div>
            <span class="title"><strong>물 품 수 정</strong></span><br><br><br>
        </div>
        <hr class="line1">
        <form method="post" enctype="multipart/form-data" action="Product_RegistarChangePro.jsp">
        <table>
            <tbody>
                 <tr>
                    <th>물품명</th>
                    <td style="width:300px;"><input type="text" class="inputbox" name="P_PNAME" autocomplete="off" value="<%=P_PNAME%>"  required /></td>
                </tr>
                 <tr>
                    <th>수량</th>
                    <td style="width:300px;"><input type="text" class="inputbox" name="P_AMOUNT" autocomplete="off" value="<%=P_AMOUNT%>" required/></td>
                </tr>
                <tr>
                    <th>학과</th>
                    <td style="width:300px;"><input type="text" class="inputbox" style="border:none;" name="DNAME" value="<%=session.getAttribute("DNAME")%>" readonly /></td>
                </tr>
                <tr>
                    <th>학번</th>
                    <td style="width:300px;"><input type="text" class="inputbox" style="border:none;" name="P_SNUM" value="<%=session.getAttribute("SNUM")%>" readonly /></td>
                </tr>
                <tr>
                    <th>작성자</th>
                    <td style="width:300px;"><input type="text" class="inputbox" style="border:none;" name="SNAME" value="<%=session.getAttribute("SNAME")%>" readonly /></td>
                </tr>
                <tr class="filebox">
                    <th>물품이미지</th>
                    <td><input class="fileimage" type="file" name="P_IMAGES" size=40></td>
                    <td hidden><input type="text" name="P_PNUM" value="<%=P_PNUM%>" readonly></td>
                </tr>
            </tbody>
            <button type="submit" class="buttonl">수정</button>
