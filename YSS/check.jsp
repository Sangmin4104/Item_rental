...
<body>
    ...
    %> 
        ...
        <div>
            <span class="title"><strong>신 청 요 청 확 인</strong></span>
        </div>

                <table class="table table-stripped table-hover" style="position:relative; top:60px; right: 30px;">
                    <thead>
                      <tr align="center">
                        <th scope="col">승인요청날짜</th>
                        <th scope="col">제 품 번 호</th>
                        <th scope="col">대여신청자 학 번</th>
                        <th scope="col">수 량</th>
                        <th scope="col">대여시작일</th>
                        <th scope="col">대여종료일</th>
                        <th scope="col">물품명</th>
                        <th scope="col">주문 번호</th>
                        <th scope="col">승인 및 거절</th>
                      </tr>
                    </thead>
...
String sql = "";
 try{
  ...
  conn=DriverManager.getConnection(jdbcUrl, dbId, dbPass );
   ...
   sql = "SELECT b.PR_YID, d.P_PNAME ,a.C_SNUM , to_char(a.C_START, 'yyyy-mm-dd') C_START ,a.C_PNUM ,b.PR_AMOUNT ,to_char(b.PR_START, 'yyyy-mm-dd') PR_START , to_char(b.PR_END, 'yyyy-mm-dd') PR_END FROM C_CHECK a ,PROD_DOC b ,ID c  ,PROD d where a.C_CHECK ='대기' and d.P_SNUM = ? and c.SNUM =a.C_SNUM  and a.C_PNUM = d.P_PNUM and b.PR_PNUM = a.C_PNUM and b.PR_YID = a.C_YID  ";
...
<tr align="center">
    ...
    <td><%=PR_YID%></td>
   <td> 
  <input type="submit" class="buttonl" value="승인" onclick="location='checkpro.jsp?PR_YID=<%=PR_YID%>'" >
 <input type="submit" class="buttonl2" value="거절" onclick="location='checkunpro.jsp?PR_YID=<%=PR_YID%>'" >
 </td>
</tr>
