...
.buttonl{
        ...
        display: inline-block;
        font-size: 18px;
        position: relative; top:-65px; left:555px;
    }
    .buttonl:hover{
        background-color: black;
        border-radius:5px;
    ...
    .buttonl2{
        ...
        display: inline-block;
        font-size: 18px;
        position: relative; top:-100px; left:665px;
    }
    .buttonl2:hover{
        background-color: black;
        border-radius:5px;
...
<body>
    ...
    %> 
      ...
      <form method="post" action="dspro.jsp">
        <div>
            <span class="title"><strong>동 의 서</strong></span>
        </div>
        <div>
            <img class="imgs4" src="img/abogam.png"  >
        </div>
         
<tr align="center">
<p><input type="text" id="d" name="d" style="width:500px" value = "<%=datetimes%>" hidden/></p>
    <td><p><input type="text" id="p_pname" name="p_pname"  value = "<%=p_pname%>" hidden/></p></td>
    <td><p><input type="text" id="dname" name="dname"  value = "<%=dname%>"hidden /></p></td>
    <td><p><input type="text" id="sname" name="sname" value = "<%=sname%>"hidden /></p></td>
    <td><p><input type="text" id="amount" name="amount"  value = "<%=amount%> "hidden/></p></td>
     <p><input type="text" id="d" name="d" style="width:500px" value = "<%=datetimes%>" hidden/></p>
     <input type="text" id="p_pnum" name="p_pnum" value=<%=p_pnum%> class="boxP" hidden>
    <td> <p><input type="text" id="d1" name="d1"  hidden></p></td>
    <td> <p><input type="text" id="d2" name="d2"  hidden></p></td>
     <td><p><input type="text" id="k" name="k"  value = "<%=k%> "hidden/></p></td>
</tr>
<input type="submit" class="buttonl" value="동의" >

</form>

<input type="submit" class="buttonl2"  value="거절" Onclick="gubu()">
