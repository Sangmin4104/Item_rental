...
<div class="card">
    ...
    <button type="submit" class="button" onclick="location='ds.jsp?P_PNUM=<%=p_pnum%>&P_PNAME=<%=p_pname%>&DNAME=<%=dname%>&SNAME=<%=sname%>&P_SNUM=<%=p_snum%>&P_AMOUNT=<%=p_amount%>&P_RENTAL=<%=p_rental%>'">대여하기</button> 
</div>
<!-- <tr align="center">
    <td><%=p_pname%></td>
    <td><%=dname%></td>
    <td><%=sname%></td>
    <td><%=p_amount%></td>
    <td><img src="p_img/<%=p_images%>" width="200" height="200"></td>
</tr>

<button type="submit" class="button" style=" position:relative; top:-22px; left:235px;" onclick="location='MainPage.jsp'" >대여하기</button>  -->
